            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">CREDIT CARDHOLDER INFORMATION</div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">BILING ADDRESS </div>
                        <div class="panel-body">
                            <fieldset>
                        ...
                        <div class="panel-body">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="name">TYPE OF CHARGES</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <?php echo $form->textField($model,'auth_charges',array('class'=>'form-control')); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="name">DATE OF CHARGES</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-9">
                                        <div class="form-group">
                    ...
                    <div class="row"  style="display:none ;">
                        <div class="col-sm-12">
                            <div class="panel-heading"><strong>AUTHORIZATION OF CARD USE</strong></div>
...
<script>
   ...
   // $('#subBtn3').attr('disabled','disabled');
    $(document).ready(function(){
        ...
        $('#CreditCardAuthorization_cc_number').mask('0000000000000000');
