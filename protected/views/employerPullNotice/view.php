...
$menuArr=array(
    ...
    array('label'=>'Authorize EPN Form',
        'url'=>'employerPullNotice/authorizeSign&id='.$model->id ,
        'icon'=>'fa fa-pencil'),
...
<h1 class="no-print">View Employee Pull Notice Program #<?php echo FilingGenerics::showEpnId($model->id); ?></h1>
<br class="no-print"><br class="no-print">
<div class="row" style="padding-bottom: 50px;">
    <div class="col-lg-10">
        <img id="formImg" class="img-responsive img" src="http://fmcsafiling.com/epn-<?php echo $model->id; ?>.jpg?id=<?php echo date('Ymdhis')?>" >
    </div>
