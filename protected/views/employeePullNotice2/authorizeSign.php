...
<div class="row" style="padding-bottom: 50px; ">
    ...
    <div class="col-lg-12" >
        <img id="formImg" class="img-responsive img" src="http://fmcsafiling.com/epn2-<?php echo $model->id; ?>.jpg" style="border: 1px solid #000000 ;">
    </div>
    ...
    function onSaveclick(){
        ...
        html2canvas($("#signBoard"), {
            onrendered: function(canvas) {
                ...
                var sendUrl= '<?php echo $this->createUrl('/employeePullNotice2/saveScr',array('id'=>Yii::app()->request->getParam('id'))); ?>';
                $.ajax({
                    type:'POST',
                    url: sendUrl,
