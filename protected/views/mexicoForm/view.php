...
$menuArr=array(
    ...
    array('label'=>'Manage New Mexico WD Permit Form',
        'url'=>'mexicoForm/admin' ,
        'icon'=>'fa fa-cog'),

    array('label'=>'Update New Mexico WD Permit Form',
        'url'=>'mexicoForm/update&id='.$model->id ,
        'icon'=>'fa fa-pencil'),

    /*array('label'=>'Authorize New Mexico WD Permit Form',
...
$this->menu=array(
	...
	array('label'=>'Update DotTrackerMexico', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete DotTrackerMexico', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage DotTrackerMexico', 'url'=>array('admin')),
);*/
?>

<h1>View New Mexico WD Permit Form #<?php echo $model->id; ?></h1>
