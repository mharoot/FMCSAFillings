...
class CGridView extends CBaseListView
{
	 ...
	 */
	public $template="<div class=\"yii-grid\"><div class=\"summary\">{summary}</div><div class=\"table\">{items}</div><div class=\"pager\">{pager}</div></div>";
	...
	public function init()
	{
		...
		/** INDITION.begin make table class default to bootstrap table classes */
		if (empty($this->itemsCssClass) || $this->itemsCssClass == 'items'){
			$this->itemsCssClass = 'table table-hover table-responsive table-striped table-bordered';
		}
		/** INDITION.end */
