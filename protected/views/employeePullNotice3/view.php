...
$menuArr=array(
    ...
    array('label'=>'Manage EPN Form',
        'url'=>'employeePullNotice3/admin' ,
        'icon'=>'fa fa-cog'),

    array('label'=>'Update EPN Form',
        'url'=>'employeePullNotice3/update&id='.$model->id ,
        'icon'=>'fa fa-pencil'),

    array('label'=>'Authorize EPN Form',
        'url'=>'employeePullNotice3/authorizeSign&id='.$model->id ,
        'icon'=>'fa fa-pencil'),
...
<h1 class="no-print">View Agreement #<?php echo $model->id; ?></h1>
<br class="no-print"><br class="no-print">
<div class="row" style="padding-bottom: 50px;">
    <div class="col-lg-10">
        <img id="formImg" class="img-responsive img" src="http://fmcsafiling.com/epn3-<?php echo $model->id; ?>.jpg?id=<?php echo date('Ymdhis')?>" >
    </div>
