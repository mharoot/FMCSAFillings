...
/**
 * This is the model class for table "dot_tracker_mc_detachment".
 *
 * The followings are the available columns in table 'dot_tracker_mc_detachment':
 * @property integer $id
 ...
 */
class DotTrackerMcDetachment extends CActiveRecord
{
	/**
	...
	{
		return 'dot_tracker_mc_detachment';
	}
	 ...
	 * @return DotTrackerMcDetachment the static model class
	 */
