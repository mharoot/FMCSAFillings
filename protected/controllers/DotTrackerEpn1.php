...
class DotTrackerEpn1 extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array(' company_name, dba, attention, email_address, telephone, mailing_address, city, state, zip, acc_person, acc_email_address, acc_telephone, acc_street_address, acc_city, acc_state, acc_zip, billing_person, billing_telephone, billing_attention, billing_telephone2, billing_address, billing_city, billing_state, billing_zip, licensing_name, licensing_title, licensing_dl_nmber, licensing_state, licensing_expiration, licensing_email, licensing_federal_employer, purpose_enrollment, all_employee_mandate, issued_requester_code, issued_requester_code_a, issued_requester_code_b, creation_datetime, created_by', 'required'),
			array('sign_link, extra,telephone_ext,acc_telephone_ext,billing_telephone_ext,billing_telephone2_ext', 'safe'),
			array('id, all_employee_mandate, issued_requester_code, extra', 'numerical', 'integerOnly'=>true),
