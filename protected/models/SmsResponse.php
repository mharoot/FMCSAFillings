...
/**
 * This is the model class for table "smsr".
 *
 * The followings are the available columns in table 'smsr':
 * @property integer $id
 ...
 */
class SmsResponse extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('fromPhone, toPhone, content, creationdatetime', 'required'),
			array('resp, ext1, ext2', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, resp, fromPhone, toPhone, content, creationdatetime, ext1, ext2', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('resp',$this->resp,true);
	 ...
	 * @return SmsResponse the static model class
	 */
