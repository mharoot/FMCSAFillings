...
/**
 * This is the model class for table "dot_tracker_kentucky".
 *
 * The followings are the available columns in table 'dot_tracker_kentucky':
 * @property integer $id
 ...
 */
class DotTrackerKentucky extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			...
			'ext1' => 'GROSS VEHICLES WEIGHT (GVW)',
			'ext2' => 'Ext2',
			'ext3' => 'Ext3',
			'ext4' => 'Ext4',
			'ext5' => 'Ext5',
	 ...
	 * @return DotTrackerKentucky the static model class
	 */
