...
<h1 class="no-print">Authorize Employee Pull Notice Program(Agreement) #<?php echo FilingGenerics::showEpnId($model->id); ?></h1>
...
<div class="row" style="padding-bottom: 50px; ">
    ...
    <div class="col-lg-12" >
        <img id="formImg" class="img-responsive img" src="http://fmcsafiling.com/epn3-<?php echo $model->id; ?>.jpg" style="border: 1px solid #000000 ;">
    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="text-align:center;font-size: large; color:green;"><i class="fa fa-check"></i> Employee Pull Notice Form has been submitted successfully.</p>
            </div>
    ...
    function onSaveclick(){
        ...
        html2canvas($("#signBoard"), {
            onrendered: function(canvas) {
                ...
                var sendUrl= '<?php echo $this->createUrl('/employeePullNotice3/saveScr',array('id'=>Yii::app()->request->getParam('id'))); ?>';
                $.ajax({
                    type:'POST',
                    url: sendUrl,
