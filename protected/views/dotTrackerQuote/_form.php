...
<?php $form=$this->beginWidget('CActiveForm', array(
                    ...
                    <ol>
                        <li>
                            ...
                            <div style="margin-left: 85px;">
                                <?php echo $form->textField($model,'s_address2',array('rows'=>6, 'cols'=>50)); ?></div>
                        </li>
                        <li>
                            <label>City</label>
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Save' : 'Edit Changes'); ?>
		<?php echo CHtml::button($model->isNewRecord ? 'Save & Email' : 'Edit Changes & Email'); ?>
	</div>
