...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
	        ...
	        <li class="active">INSTRUCTIONS for FORM OP-1</li>
	    </ol>
    </div>
</div>
                  ...
                  <div class="panel-body">
                    <fieldset>
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="mcff" name="mcff" size="30" type="text" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <input class="form-control" id="legalBus" name="legalBus" size="30" type="text" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <input class="form-control" id="busName" name="busName" size="30" type="text" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group smText">
                                    ...
                                    <input class="form-control" id="street-add" name="street-add" size="30" type="text" />
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group smText">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group smText">
                                    7. ZIP CODE<br />
                                    <input class="form-control" id="zipcode" name="zipcode" size="30" type="text" />
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group smText">
                                    8. TELEPHONE<br />
                                    <input class="form-control" id="telphone" name="telphone" size="30" type="text" />
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group smText">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class='form-group'>
                                    <input class="form-control" id="usDot" name="usDot" size="30" type="text" />
                                </div>
                            </div>
                        </div>
                            ...
                            <fieldset>
                                <div class="row">
                                    ...
                                    <div class="col-sm-11" style="padding: 20px 0 0 50px;">
                                        ...
                                        <div class="col-sm-6 form-group"><input type="text" name="nameOnCard"></div>
                                        <div class="col-sm-6"><label>Payment Amount:</label></div>
                                        <div class="col-sm-6 form-group"><input type="text" name="payAmt"></div>
                                        ...
                                        <div class="col-sm-3 form-group"><input type="text" name="stName"></div>
                                        <div class="col-sm-2 form-group"><label>City:</label></div>
                                        <div class="col-sm-3 form-group"><input type="text" name="city"></div>

                                        <div class="col-sm-4 form-group"><label>State/Province:</label></div>
                                        <div class="col-sm-3 form-group"><input type="text" name="state"></div>
                                        <div class="col-sm-2 form-group"><label>Zip Code:</label></div>
                                        <div class="col-sm-3 form-group"><input type="text" name="zipcode"></div>
                                    
                                        <div class="col-sm-4 form-group"><label>Signature:</label></div>
                                        <div class="col-sm-3 form-group"><input type="text" name="billSign"></div>
                                        <div class="col-sm-2 form-group"><label>Payment Date:</label></div>
                                        <div class="col-sm-3 form-group"><input type="text" name="PayDate"></div>
                                    </div>
...
<style type="text/css">
    .smText{font-size: 12px!important;}
    .smBold{ font-weight: 600; }
    .right{ text-align: right; }
    .singleBrd{border-left: #fff solid 1px; border-right: #fff solid 1px; border-top: #fff solid 1px;border-bottom: #333 solid 1px;}
</style>